...
synopsis2 = "detailed description:\n\
 ...
 2. Output file and options:\n\
  - by default, write results to '${<mclOutput>%%.txt}.parsed.txt'\n\
  ...
  - '-S': print a summary to '${<mclOutput>%%.txt}.parsed.txt'; requires '-p'\n\
...
by ohdongha@gmail.com 20180329 ver 1.0.3\n\n"
...
if not args.no_parsed_txt:
	...
	print "done parsing %d clusters, for %s\n" % (num_clusters_processed, args.mclOutput.name)
