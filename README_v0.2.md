...
## News and Updates
- 2022-04-XX v.0.2 (started)
	- added iterative MCL, see note for details 
	- added wrapper scripts for the CLfinder and ONfinder modules 
- 2021-09-30 v.0.1 (cumulative changes wrapped up as a release)
	- added `cluster_OrthNet_topology_exact.py` (previously `search_OrthNet_topology.py`) and `search_OrthNet_CNVs.py`
	- added options to use [MMseqs2](https://github.com/soedinglab/mmseqs2) to generate inputs #2 and #3.  MMseqs2 is much faster than orthoMCL or BLASTP and also generate one HSP (High-scoring Segment Pair) per each sequence comparison. 
	- minor bug fixes and improvements
- 2019-02-01 The first CLfinder-OrthNet paper was published in [*DNA Research*](https://doi.org/10.1093/dnares/dsy035). 
- 2019-01-12 CLfinder-OrthNet was presented at *Plant&Animal Genomes 2019* ([details and abstracts](https://plan.core-apps.com/pag_2019/speaker/6e070c0ebde6a5b908f9f08fb2f126ac))
